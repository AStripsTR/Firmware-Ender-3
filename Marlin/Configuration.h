...
#define CUSTOM_MACHINE_NAME "Ender-3 V427 BLTouch"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -5, 3 }
...
#define Z_AFTER_HOMING         2.7 // (mm) Height to move to after homing (if Z was homed)
